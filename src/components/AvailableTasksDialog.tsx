...
// ✅ All hooks are used inside the component
...
const sampleTasks: Task[] = [
  {
    ...
    description:
      "Label objects in street scene images to train AI for self-driving cars. Help make transportation safer.",
  ...
  },
  {
    ...
    description:
      "Categorize medical documents and research papers to improve healthcare AI systems.",
  ...
  },
  {
    ...
    description:
      "Transcribe audio recordings in multiple languages to improve speech recognition AI.",
  ...
  },
  {
    ...
    description:
      "Create and annotate 3D models for augmented reality applications and gaming AI.",
  ...
  },
  {
    ...
    description:
      "Review and categorize social media content to train AI moderation systems.",
  ...
  },
  {
    ...
    description:
      "Extract and structure data from financial reports to train AI for automated analysis.",
...
export const AvailableTasksDialog = () => {
  ...
  const handleGoToDashboard = () => {
    navigate("/dashboard"); // ✅ Works fine now
  };
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-lg">
            Browse current opportunities and start earning with meaningful AI
            projects.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 text-white text-center">
            ...
            <p className="text-blue-100 mb-4">
              Join thousands of contributors earning competitive pay on meaningful
              AI projects. Complete your profile to get matched with the right
              tasks.
            </p>
